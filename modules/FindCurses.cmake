# ----------------------------------------------------------------------------
# Copyright (c) 2025 Andrew D Smith and original authors
#
# This file is modified from the original version distributed under
# the OSI-approved BSD 3-Clause License. See
...
Note: This module is modified from the original by including a
condition that uses the Curses_USE_STATIC_LIBS variable in a similar
way to Boost_USE_STATIC_LIBS to find the '.a' version, then reset the
state before the end of this script (not sure that's
needed). Additionally, the 'include' directives in this file do not
use paths and do not use the '.cmake' suffix, but insted use
'include(modulename)' as would be the case within a CMakeLists.txt
file.
...
if( Curses_USE_STATIC_LIBS )
  set( _curses_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES})
  if(WIN32)
...
# ADS: this is take from the FindBoost.cmake file
if( Curses_USE_STATIC_LIBS )
  set(CMAKE_FIND_LIBRARY_SUFFIXES ${_curses_ORIG_CMAKE_FIND_LIBRARY_SUFFIXES})
endif()
